  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 transition-all duration-500 ease-in-out">
      <div className="glass-card p-8 text-center">
        <h1 className="text-4xl font-bold mb-4 text-white text-modern">Welcome to the Voting DApp</h1>
        <p className="text-lg mb-8 text-white text-modern">A decentralized application for secure and transparent voting.</p>
